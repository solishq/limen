...
| Path | Role | Version | Canonical Owner | Hash | Dependency Direction | LCI Note |
|------|------|---------|-----------------|------|----------------------|----------|
| `contracts/phase-x.contracts.json` | Machine-readable Phase X compliance authority | manifest 1.0.0 | Phase X Contract Authority | `a75ea4ca4ae1b45f4723762a87192f3bbc905e7592737e0e0bb0305538cf0281` | Upstream of Phase X hash verification, HB-37/HB-38 proof, and LCI closure | Records versioned list, hashes, defense sets, monotonicity proof, LCI assertion, and closure proof. |

### 2.2 Prompt-Required Core Phase X Files

| Path | Role | Version | Canonical Owner | Hash | Dependency Direction | LCI Note |
|------|------|---------|-----------------|------|----------------------|----------|
| `contracts/SHARED_TYPES.md` | Canonical shared type registry | 1.3.0 | Phase X Shared Types Authority | `0a6e8bc52973656450a80b900cd69052cf03907babd32cf699ba309b699ac0b8` | Upstream of every Phase X contract | CanonicalTypes source; no parallel shared-type registry allowed. |
...
| `contracts/AGENT_ADAPTER_ARCHITECTURE.md` | Pluggable adapter architecture | 2.2.0 | Phase X Contract Authority | `739129f0fcd31b2627257671072d01a2b9969e244a570115ccb2d8814b607205` | Depends on shared types, memory bridge, and computer use governance | Adapter actions translate into canonical types before governance and audit. |
...
| `contracts/AGENT_LIFECYCLE_MANAGEMENT.md` | Agent registration, trust, consent, and knowledge exchange | 1.3.0 | Phase X Contract Authority | `5954f6fae2fa62db5fc317ec20e48ba12e71636bfd4dbe8c929a203accd486b0` | Depends on shared types; upstream of adapter binding and session lifecycle | LifecycleState, ConsentGate, and trust/capability closure. |
