 ...
 *
 * All types defined here are LOCAL to the CrewAI adapter contract.
 * Cross-contract types are imported from SHARED_TYPES.md canonical sources.
 *
...
/** CREWAI_ADAPTER_CONTRACT.md S3.4 -- RecallResult */
...
/** CREWAI_ADAPTER_CONTRACT.md S3.5 -- MergeResult */
...
/** CREWAI_ADAPTER_CONTRACT.md S3.5 -- MergeConflictRecord */
...
/** CREWAI_ADAPTER_CONTRACT.md S3.5 -- ManualMergeResolutionRequest */
...
/** CREWAI_ADAPTER_CONTRACT.md S3.7 -- RetryPolicy */
...
/** CREWAI_ADAPTER_CONTRACT.md S3.8 -- AdapterHealth */
...
/** CREWAI_ADAPTER_CONTRACT.md S9.1 -- Adapter lifecycle state */
...
// ── Error codes (CREWAI_ADAPTER_CONTRACT.md S6.1) ──

/** CREWAI_ADAPTER_CONTRACT.md S6.1 -- Error codes */
export type CrewAIAdapterErrorCode =
  | 'NOT_INITIALIZED'
  | 'ALREADY_INITIALIZED'
...
/** CREWAI_ADAPTER_CONTRACT.md S6.2 -- Deterministic error precedence (1=highest) */
export const ERROR_PRECEDENCE: Record<CrewAIAdapterErrorCode, number> = {
  'NOT_INITIALIZED': 1,
...
/** CREWAI_ADAPTER_CONTRACT.md S6.2 -- Non-retryable errors (Claims 4.2, 4.3) */
export const NEVER_RETRYABLE: ReadonlySet<CrewAIAdapterErrorCode> = new Set([
  'NOT_INITIALIZED',
  'GOVERNANCE_REFUSAL',
]);
