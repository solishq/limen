...
- Out: core LLM training, non-agent memory stores, UI/UX beyond governance dashboard, languages other than English (known limitation, bounded).

**Constraints (non-negotiable under constitution):**  
- Contracts-first, no copy/patch/shortcuts/assumptions (per SolisForge v1.5 Generic Reference).  
- Git-first on dedicated per-phase branches (v1.5-constitution/phase-0, etc.), cleared and approved before next phase.  
- Every decision audited before implementation (standing order).  
...
**Note:** This is a complete restart. Old Limen V5 Git work (pre-v1.5-generic) is archived as legacy and not part of this chain. No assumptions carried forward.